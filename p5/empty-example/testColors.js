...
var pintura="";
var lista="";
var numeroDeOrdenLista=0;
var numeroDeOrden=0;
var previaOrden=0;
const CIRCULO = 0;
const CUADRADO = 1;
const LISTA_HORIZONTAL = 2;
const LISTA_VERTICAL = 3;
const TERMINAR = 4;
const MAX_CANTIDAD_COLORES = 3;

function testMe(){
    obtenerColorRandom();
    crearPintura();
    
    document.getElementById("ordenes").value = pintura;
    reiniciarVariables();
}
    ...
    switch (eleccion) {
        ...
        case LISTA_HORIZONTAL: //lista de pinturas
            ...
            for (var i = 0; i< cantidadDePinturas ;i++){
                ...
                switch(cuadradoOCirculo){
                   case CIRCULO:
                        pintura+= dameUnCirculo();
                   break;
                   case CUADRADO:
                        pintura+= dameUnCuadrado();
                   break;
               }
            }
            pintura +=">";
...
function dameUnCuadrado(){
    var cuadrado="";
    cuadrado +="[";
    cuadrado += obtenerColorRandom();
    cuadrado +=" ";
    cuadrado +=obtenerColorRandom();
    cuadrado +=" ";
    cuadrado +="]";
...
function dameUnCirculo(){
    var circulo="";
    circulo +="[";
    circulo += obtenerColorRandom();
    circulo +=" ";
    circulo +=obtenerColorRandom();
    circulo +=" ";
    circulo +="]";
...
function encontrarColor(nombre){
    for ( var i = 0 ; i < DATA.length; i++){
        if (DATA[i][0].toUpperCase() === nombre.toUpperCase()){
            return DATA[i][1];
        }
    }
}
